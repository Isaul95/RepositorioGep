...
public class Ventasdeldia {
      ...
      public void Listadeventas(ArrayList columna1, ArrayList columna2){
      ...
      for(int n=0;n<=columna1.size()-1;n++){  
          String a =String.valueOf(columna1.get(n));
           if (a.length()> 12) { // si la descripcion_producto es mayor a 17 la corta
             ...
             auxs+= String.format("%-20s" + "%-17s", a, columna2.get(n));
 System.out.println(String.format("%-20s" + "%-17s",a, columna2.get(n)));
