...
String nom = pollocrudnombre.get(n).toString();                  
            ...
            auxs+= String.format("%-14s" + "%-6s"+ "%-5s" + "$%-5s", nom, sobrante.get(n), pollocrudpieza.get(n), pollocrudtotal.get(n)); System.out.println(String.format("%-14s" + "%-6s" +"%-5s"+ "$%-5s",nom, sobrante.get(n),pollocrudpieza.get(n), pollocrudtotal.get(n)));
             auxs+= "\n";   
        }                  
            auxs+= "\n==============================\n";  System.out.println("\n==============================\n");  
