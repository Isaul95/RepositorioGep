...
public class ticketventacredito {
    
    
       public void tikectdeventaacredito(String nombrecredito, ArrayList nombre, 
               ArrayList piezas, 
               ArrayList precio, 
               ArrayList importe, 
       ...
       auxs+= String.format("A nombre de:  "+"%-20s", nombrecredito); System.out.println(String.format("A nombre de:   "+"%-20s", nombrecredito));
       auxs+= "\n";
       System.out.println("\n==============================\n");  auxs+= "\n==============================\n";              
