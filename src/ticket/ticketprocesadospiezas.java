...
public class ticketprocesadospiezas {
     ...
     public void ticketprocesadospiezas(Object nombre, Object piezas, Object total) {
        ...
        // Se llama al metodo para imprimir una cadena
         auxs+= "PROCESADOS PIEZAS\n\n";          System.out.println("PROCESADOS PIEZAS\n\n");
...
auxs+= "Nombre          Piezas\n";           System.out.println("Nombre          Piezas\n");      
         ...
         auxs+= String.format("%-10s" + "%-17s" + "%-10s", nombre, piezas, total); System.out.println(String.format("%-10s" + "%-17s" + "%-10s", nombre, piezas, total));
             auxs+= "\n";            
       auxs+= "\n==========================================\n";  System.out.println("\n==========================================\n");  
       auxs+= "    PROCESADOS PIEZAS       \n\n\n\n\n";// Varios saltos para no cortar antes 
System.err.println("    PROCESADOS PIEZAS       \n\n\n\n\n");       
