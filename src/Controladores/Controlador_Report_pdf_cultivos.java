...
public class Controlador_Report_pdf_cultivos {
   ...
   // ***********************    REPORTE DE CULTIVOS    ************************** 
        ...
        if(result == 0){         */   
            try {
                ...
                parametro.put("parameter1",Muestra_de_Cultivos.id_venta.getText()); 
...
System.out.println("aki desde controller Muestra_de_Cultivos id" + Muestra_de_Cultivos.id_venta.getText());
