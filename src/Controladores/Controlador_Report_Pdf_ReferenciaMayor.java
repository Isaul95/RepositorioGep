...
public class Controlador_Report_Pdf_ReferenciaMayor {
...
System.out.println("aki desde controller id" + Capturar_resultados.id_venta.getText());
                ...
                String path = "src/Reportes/report3_1_1.jasper";                
                reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/report3_1_1.jasper")); // ASI MANDO A LLAMAR LOS REPORTES CON .jasper 
                // ========================= LLENADO DEL REPORTE  ======================  /
