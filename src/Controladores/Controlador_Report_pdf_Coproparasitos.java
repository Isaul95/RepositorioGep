...
public class Controlador_Report_pdf_Coproparasitos {
    ...
    private final String firma = "/Reportes/firma.png";      //  imahgen de firma.png  
     public void Generacion_PDF_Coproparasitos(){                                           
   // ***********************    REPORTE DE CULTIVOS    ************************** 
        SI cc= new SI();  
        ...
        if(result == 0){         */   
            try {
                ...
                parametro.put("parameter1",Captura_Coproparasitoscopico.id_venta.getText()); 
...
System.out.println("aki desde controller Muestra_de_CultivoXXX PARASITOSs id" + Captura_Coproparasitoscopico.id_venta.getText());
                JasperReport reporte = null; // String path = "src/Reportes/report3.jasper";
                String path = "src/Reportes/reporte_coproparasitos.jasper";                
                reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/reporte_coproparasitos.jasper")); // ASI MANDO A LLAMAR LOS REPORTES CON .jasper 
                // ========================= LLENADO DEL REPORTE  ======================  /
