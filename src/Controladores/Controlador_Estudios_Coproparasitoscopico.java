...
public class Controlador_Estudios_Coproparasitoscopico {
...
//    PDF CORTO
      ...
      public static void limpiarTxtBacterias(){                 
            Captura_Coproparasitoscopico.txtbacteria1.setText(null);
         }  

    public static void insertResultadosDeCoproparasitoscopico() {
        if (Captura_Coproparasitoscopico.txtbacteria1.getText().isEmpty() ) {
            JOptionPane.showMessageDialog(null, "Debe llenar los campos vacios.");
        } else{ 
        String item = Captura_Coproparasitoscopico.ComboResultados2.getSelectedItem().toString(); 
        String result = Captura_Coproparasitoscopico.ComboResultadoCoproparasitos.getSelectedItem().toString(); 
        
        Modelo_Coproparasitoscopico.inserciondeResultadosDeCoproparasitoscopico(Captura_Coproparasitoscopico.txtbacteria1.getText(), result , item);
        Modelo_Coproparasitoscopico.LlenarTabladeBacterias(Captura_Coproparasitoscopico.jTableCoproparasitos);
        limpiarTxtBacterias();
        }
    }
}
